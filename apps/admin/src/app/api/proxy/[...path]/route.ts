 ...
 *
 * Unlike the employee app's proxy, this one forwards PUT and PATCH: an admin
 * console is mostly writes, and every one of them goes through here. It is also
 * why the admin uses TanStack mutations rather than Server Actions — a Server
 * Action would bypass this handler and need a second, parallel implementation of
 * the refresh dance.
 */
